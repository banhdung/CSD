...
/* 
   ...
   Neu dung khi chay truc tiep se bao loi va nhan 0 diem
    ...
    void addLast(String xOwner, int xPrice, int xColor) {
        //You shuld write here appropriate statements to complete this function.
...
//==================================================================
    void addFirst(Bat x) {//You should write here appropriate statements to complete this function.
