...
public class MyList {
   ...
   Neu dung khi chay truc tiep se bao loi va nhan 0 diem
    ...
    //==================================================================
    void addAfterP(Node p, Castor x) {
        Node p1 = new Node(x);
        if (isEmpty()) {
            return;
        }
    ...
    void insert(Castor x, int position) {
        int count = 0;
        Node p = head;
        while (p.next != null) {
            if (count == position - 1) {
    ...
    void addFirst(Castor x) {//You should write here appropriate statements to complete this function.
